...
extension CirclePhotoCollectionViewCell: ConfigureCell {
    func setup(withItem item: Any, andIndexPath indexPath: IndexPath) {
        ...
        imageButton.kf.setImage(with: ImageResource(downloadURL: galleryImage.codeID.convertToURL(withSize: .Medium, inMode: .Get), cacheKey: galleryImage.codeID), for: .normal,
